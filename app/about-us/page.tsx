...
const values = [
  ...
  },
  {
    ...
    description:
      "An’anaviy hunarmandchilikni zamonaviy dizayn texnikalari bilan uyg‘unlashtirib, vaqt sinovidan o‘tadigan mebellar yaratish.",
  },
  {
    icon: Users2,
                ...
                {[
                  {
                    "year": "2012",
                    "title": "Boshlanish",
                    "description": "Mukammallik sari intilgan kichik ustaxonadan faoliyat boshlandi"
                  },
                  {
                    "year": "2015",
                    "title": "Global kengayish",
                    "description": "Xalqaro hamkorlar bilan birgalikda qo‘shma loyihalar yo‘lga qo‘yildi"
                  },
                  {
                    "year": "2018",
                    "title": "Innovatsiya mukofoti",
                    "description": "Chet el tajribasi asosida yangi texnologiyalar joriy etildi"
                  },
                  {
                    "year": "2023",
                    "title": "Barqaror kelajak",
                    "description": "Ekologik toza va barqaror materiallardan iborat yangi kolleksiya taqdim etildi"
                  },
                  {
                    "year": "2026",
                    "title": "Raqamli inqilob",
                    "description": "Raqamli texnologiyalar asosida ishlab chiqarish va savdo jarayonlari avtomatlashtirildi"
                  }
                ]
                  .map((milestone, index) => (
                    <motion.div
